        ...
        <div style={{ 
            ...
            <div style={{ 
                ...
                <div style={{ position: 'relative', flex: 1 }}>
                    ...
                    <input 
                        type="text" 
                        placeholder="Search medicine shelf..." 
                                    ...
                                    >
                                        ...
                                        <td style={{ padding: '15px 20px' }}>
                                            {(() => {
                                                ...
                                                return (
                                                    <div style={{ fontWeight: 900, color: isCritical ? '#ef4444' : isPreCritical ? '#f59e0b' : '#059669', fontSize: '0.85rem' }}>
                                        ...
                                        <td style={{ padding: '15px 20px' }}>
                                            {(() => {
                                                ...
                                                const isPreCritical = days <= 120;
                                                return (
                                                    <span style={{ fontSize: '0.65rem', fontWeight: 900, padding: '4px 10px', borderRadius: '20px', background: isCritical ? '#fee2e2' : isPreCritical ? '#fef3c7' : '#ecfdf5', color: isCritical ? '#991b1b' : isPreCritical ? '#92400e' : '#065f46', display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
                                ...
                                return (
                                    ...
                                    >
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
                                            ...
                                            <span style={{ fontSize: '0.6rem', fontWeight: 900, padding: '4px 10px', borderRadius: '20px', background: isCritical ? '#fee2e2' : isPreCritical ? '#fef3c7' : '#ecfdf5', color: isCritical ? '#991b1b' : isPreCritical ? '#92400e' : '#065f46', display: 'flex', alignItems: 'center', gap: '4px', height: 'fit-content' }}>
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <div style={{ fontWeight: 950, color: isCritical ? '#ef4444' : isPreCritical ? '#f59e0b' : '#059669', fontSize: '0.85rem' }}>
                                                {days <= 0 ? 'EXPIRED' : `${days} Days Left`}
                                            </div>
                                            {isAdmin && (
