            ...
            <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                ...
                <header style={{ display: 'flex', flexDirection: window.innerWidth <= 768 ? 'column' : 'row', justifyContent: 'space-between', alignItems: window.innerWidth <= 768 ? 'flex-start' : 'center', marginBottom: '30px', gap: '20px' }}>
                    ...
                    <div style={{ display: 'flex', gap: '12px' }}>
                        ...
                        {activeShift && (
                            <div style={{ background: '#dcfce7', padding: '10px 20px', borderRadius: '14px', border: '1px solid #bbf7d0', display: 'flex', alignItems: 'center', gap: '10px', color: '#166534' }}>
                            ...
                            <>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: window.innerWidth <= 550 ? '1fr' : 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px' }}>
                                    {[
                                        ...
                                        { label: 'OPENING CASH', value: `Rs ${(activeShift.opening_cash || activeShift.openingCash || 0).toLocaleString()}`, icon: Wallet, color: '#3b82f6', bg: '#eff6ff' },
                                        { label: 'CURRENT SALES', value: `Rs ${(activeShift.sales || 0).toLocaleString()}`, icon: TrendingUp, color: '#10b981', bg: '#f0fdf4' },
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: window.innerWidth <= 600 ? '1fr' : '150px 1fr auto', gap: '15px' }}>
                                        ...
                                        <button 
                                            onClick={async () => {
                                                ...
                                                try {
                                                    await supabase.from('shifts').update({ expenses: (activeShift.expenses || 0) + amt }).eq('id', activeShift.id);
                                        ...
                                        <div key={s.id} style={{ padding: '15px', borderRadius: '16px', border: '1px solid #f1f5f9', background: '#fff', transition: 'all 0.2s', position: 'relative' }}>
                                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                                                ...
                                                <div style={{ textAlign: 'right' }}>
                                                    <p style={{ fontSize: '0.9rem', fontWeight: 950, color: '#059669' }}>Rs {s.sales?.toLocaleString()}</p>
