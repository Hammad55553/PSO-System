                ...
                <div>
                    <h2 style={{ 
                        ...
                        <div style={{ background: '#eff6ff', padding: '8px', borderRadius: '10px' }}>
                            <Truck size={window.innerWidth <= 480 ? 20 : 28} color="#2563eb" />
                        </div>
                        SUPPLIER NETWORK
                    </h2>
                            ...
                            >
                                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px', alignItems: 'center' }}>
                                    ...
                                    <div style={{ textAlign: 'right' }}>
                                        ...
                                        <p style={{ fontSize: '0.95rem', fontWeight: 950, color: sup.balance > 0 ? '#ef4444' : '#059669' }}>Rs {sup.balance.toLocaleString()}</p>
                                    </div>
                                </div>
                            ...
                            <div style={{ padding: '20px', background: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                                ...
                                <div style={{ marginTop: '12px', display: 'flex', gap: '15px' }}>
                                    ...
                                    <div style={{ flex: 1 }}>
                                        ...
                                        <p style={{ fontSize: '0.9rem', fontWeight: 950, color: selectedSupplier.balance > 0 ? '#ef4444' : '#059669' }}>Rs {selectedSupplier.balance.toLocaleString()}</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div style={{ background: 'white', width: '100%', maxWidth: '450px', borderRadius: window.innerWidth <= 480 ? '24px 24px 0 0' : '16px', overflow: 'hidden' }}>
                        ...
                        <form onSubmit={handleAddSupplier} style={{ padding: '25px', display: 'flex', flexDirection: 'column', gap: '15px' }}>
                            ...
                            <button 
                                type="submit" 
                                disabled={isSaving}
                                style={{ width: '100%', padding: '15px', background: isSaving ? '#94a3b8' : '#2563eb', color: 'white', border: 'none', borderRadius: '12px', fontWeight: 900, fontSize: '1rem', cursor: isSaving ? 'not-allowed' : 'pointer', marginTop: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}
                            >
                        ...
                        <form onSubmit={handleAction} style={{ padding: '25px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    autoFocus
                                    placeholder="0" 
                                    style={{ width: '100%', padding: '12px', border: '1px solid #e2e8f0', borderRadius: '10px', fontSize: '1.2rem', fontWeight: 950, color: actionType === 'purchase' ? '#ef4444' : '#059669', outline: 'none' }}
