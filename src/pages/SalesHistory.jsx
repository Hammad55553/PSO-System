                                    ...
                                    <div style={{ position: 'absolute', top: '110%', right: 0, background: 'white', border: '1px solid #e2e8f0', borderRadius: '12px', boxShadow: '0 10px 25px -5px rgba(0,0,0,0.1)', zIndex: 100, width: '180px', overflow: 'hidden' }}>
                                        {[
                                            ...
                                            <div 
                                                ...
                                                style={{ padding: '12px 15px', fontSize: '0.8rem', fontWeight: period === p.id ? 800 : 600, color: period === p.id ? '#2563eb' : '#64748b', background: period === p.id ? '#eff6ff' : 'white', cursor: 'pointer' }}
                                            >
                                                {p.label}
                                            </div>
                                        ))}
                                    ...
                                    >
                                        ...
                                        <td style={{ padding: '15px 20px', textAlign: 'center' }}>
                                            <span style={{ 
                                                ...
                                                padding: '4px 10px', 
                                                borderRadius: '20px',
                                                background: sale.status === 'Returned' ? '#fff1f1' : '#ecfdf5',
                                                color: sale.status === 'Returned' ? '#ef4444' : '#059669',
                                                border: `1px solid ${sale.status === 'Returned' ? '#fecaca' : '#d1fae5'}`
                                            }}>
                            ...
                            {filteredSales.map(sale => (
                                ...
                                >
                                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
                                        <span style={{ fontWeight: 900, color: '#3b82f6', fontSize: '0.8rem' }}>
                                            #{sale.invoice_no ? (100000 + parseInt(sale.invoice_no)).toString() : sale.id?.toString().slice(-6).toUpperCase()}
                                        </span>
                                        <span style={{ 
                                            fontSize: '0.6rem', 
                    ...
                    >
                        ...
                        <div style={{ padding: window.innerWidth <= 480 ? '20px' : '30px', flex: 1, overflowY: 'auto' }}>
                            <div style={{ textAlign: 'center', marginBottom: '30px', paddingBottom: '25px', borderBottom: '1px solid #f1f5f9' }}>
                                 <img src={logo} alt="Bilal Vet" style={{ height: '60px', marginBottom: '12px', objectFit: 'contain' }} />
                                 <h2 style={{ fontSize: '1.2rem', fontWeight: 950, color: '#0f172a' }}>BILAL VET CLINIC</h2>
                                 <div style={{ marginTop: '10px' }}>
                                    <p style={{ fontSize: '0.85rem', color: '#3b82f6', fontWeight: 950 }}>INVOICE #{selectedSale.invoice_no ? (100000 + parseInt(selectedSale.invoice_no)).toString() : selectedSale.id.toString().slice(-6).toUpperCase()}</p>
