...
const OrderManagement = () => {
    ...
    const shareWhatsApp = (order) => {
        ...
        const text = `📦 *BILAL VETERINARY CLINIC HASILPUR*%0A*Official Supply Order*%0A%0A---------------------------------------%0A🆔 *Order ID:* #ORD-${orderId}%0A📅 *Date:* ${date}%0A🏢 *Supplier:* ${supplier}%0A---------------------------------------%0A%0A📋 *ITEMS LIST:*%0A${itemsText}%0A---------------------------------------%0A${notes ? `📝 *Remarks:* ${notes}%0A%0A` : ''}*Generated by Bilal Vet System*`;
