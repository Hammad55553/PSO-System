        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <h2 style={{ fontSize: '1.5rem', fontWeight: 900, marginBottom: '8px', letterSpacing: '-0.5px' }}>VET SMART ERP</h2>
                ...
                <form onSubmit={handleLogin} style={{ padding: '0 40px 40px 40px' }}>
                    ...
                    <div style={{ marginTop: '20px', textAlign: 'center' }}>
                        <Link to="/register" style={{ color: '#2563eb', fontSize: '0.85rem', fontWeight: 700, textDecoration: 'none' }}>
