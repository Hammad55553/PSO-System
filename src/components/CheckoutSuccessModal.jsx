        ...
        <div className="no-print" style={{ position: 'fixed', inset: 0, background: 'rgba(255, 255, 255, 0.98)', zIndex: 10000, display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(10px)' }}>
            <div style={{ width: '450px', padding: '40px', textAlign: 'center' }}>
                ...
                <div style={{ marginBottom: '30px', animation: 'fadeInScale 0.5s ease-out' }}>
                    <img src={logo} alt="Bilal Vet Clinic" style={{ height: '120px', objectFit: 'contain' }} />
                </div>

                <h2 style={{ fontSize: '1.2rem', fontWeight: 900, color: '#10b981', letterSpacing: '4px', marginBottom: '10px' }}>READY FOR NEXT PATIENT</h2>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                    <button
                        onClick={resetPOS}
                        style={{ width: '100%', padding: '20px', background: '#10b981', color: 'white', border: 'none', borderRadius: '12px', fontSize: '1.1rem', fontWeight: 950, cursor: 'pointer', boxShadow: '0 20px 25px -5px rgba(16, 185, 129, 0.2)', transition: 'transform 0.2s' }}
