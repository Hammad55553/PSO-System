    ...
    return (
        <div id="thermal-receipt" className="receipt-thermal-terminal print-only" style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '10px' }}>
                ...
                <h1 style={{ margin: '0 0 2px 0', fontSize: '18px', fontWeight: '900', textTransform: 'uppercase' }}>BILAL VETERINARY CLINIC</h1>
                <p style={{ margin: 0, fontSize: '10px', fontWeight: 700 }}>Near HBL Bank Khoka Market Hasilpur</p>
            ...
            <div style={{ textAlign: 'center', marginTop: '20px', fontSize: '9px' }}>
                ...
                <p style={{ margin: 0 }}>Consult our Vet for best medical advice.</p>
            </div>
        </div>
    );
};
